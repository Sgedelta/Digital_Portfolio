...
let langAnimationCounter = 0;
const langAnimations = () => {
    switch(langAnimationCounter) {
        case 0:
        ...
        default:
            langAnimationCounter = -1;
            playAnimation(defaultElements);
        break;
    }
    langAnimationCounter++;
...
const animationSetup = () => {
    ...
    document.querySelector("#logo").addEventListener('click', langAnimations);
}
